...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Echoes AI - Spreadsheet ROI Generator"
    )
    parser.add_argument(
        "--config", default="stakeholder_email_roi.yaml", help="YAML configuration file"
    )
    parser.add_argument(
        "--output", default="pilot_a_roi_analysis", help="Output filename base"
    )
