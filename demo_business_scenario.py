...
class BusinessScenarioDemo:
    ...
    def _phase_1_inventory_analysis(self):
        ...
        inventory_items = [
            {"sku": "LAPTOP-001", "name": "Gaming Laptop Pro", "category": "Laptops", 
             "quantity": 150, "location": "Warehouse-A", "min_stock": 50, "max_stock": 200,
             "cost": 1200, "price": 1799, "monthly_sales": 45},
            {"sku": "MOUSE-001", "name": "Wireless Mouse Elite", "category": "Peripherals",
             "quantity": 25, "location": "Warehouse-A", "min_stock": 100, "max_stock": 500,
             "cost": 15, "price": 39, "monthly_sales": 320},
            {"sku": "KEYBOARD-001", "name": "Mechanical Keyboard Pro", "category": "Peripherals",
             "quantity": 80, "location": "Warehouse-B", "min_stock": 60, "max_stock": 300,
             "cost": 45, "price": 89, "monthly_sales": 120},
            {"sku": "MONITOR-001", "name": "4K Monitor Ultra", "category": "Monitors",
             "quantity": 200, "location": "Warehouse-A", "min_stock": 40, "max_stock": 150,
             "cost": 350, "price": 599, "monthly_sales": 30},
        ]
        ...
        if result["success"]:
            self.print_result("Workflow completed", f"{len(result['steps'])} steps, {result['total_duration_ms']:.0f}ms")
            ...
            opportunities = [
                {
                    ...
                    "current_loss": revenue_data["monthly_orders"] * revenue_data["cart_abandonment_rate"] * revenue_data["avg_order_value"],
    ...
    def _phase_5_executive_report(self):
        ...
        self.assistant.write_file(
            "data/executive_report_q4_2025.json",
            json.dumps(report, indent=2)
        )

        print("\n✓ Executive report generated")
        print(f"✓ Report saved: data/executive_report_q4_2025.json")
