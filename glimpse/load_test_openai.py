...
PROMPT_POOL = [
    ...
    (
        "Explain the new API authentication flow.",
        "explain auth flow",
        "include code examples",
    ),
    (
        "Generate a release notes draft for v2.1.",
        "generate release notes",
        "highlight breaking changes",
    ),
    (
        "Outline the migration steps from old to new schema.",
        "outline migration steps",
        "assume PostgreSQL",
    ),
    (
        "Write a brief intro for the blog post on AI ethics.",
        "write intro",
        "tone: professional",
    ),
    (
        "Create a technical summary of the latest security patch.",
        "summarize security patch",
        "focus on CVEs",
    ),
    (
        "Draft an email to stakeholders about the outage.",
        "notify stakeholders",
        "include RCA",
    ),
    (
        "Provide a quick overview of the new feature flags.",
        "describe feature flags",
        "give examples",
    ),
    (
        "Summarize user feedback from the last sprint.",
        "summarize feedback",
        "highlight themes",
    ),
    (
        "Explain how the new caching layer works.",
        "explain caching",
        "include pseudo-code",
    ),
]
