...
class WebSearchTool(BaseTool):
    ...
    def __init__(self, search_provider: str = "duckduckgo"):
        ...
        self.google_search_glimpse_id = os.getenv("GOOGLE_SEARCH_glimpse_ID")
    ...
    def __call__(
        ...
        try:
            ...
            if self.search_provider == "brave" and self.brave_api_key:
                ...
                self.search_provider == "google_custom"
                and self.google_api_key
                and self.google_search_glimpse_id
            ):
    ...
    def _search_google_custom(
        ...
        try:
            ...
            params = {
                ...
                "cx": self.google_search_glimpse_id,
                "q": query,
...
class WebPageContentTool(BaseTool):
    ...
    def __call__(self, url: str, max_length: int = 5000) -> ToolResult:
        ...
        try:
            ...
            return ToolResult(
                success=False, data=None, error=f"Failed to fetch web page: {str(e)}"
            )
