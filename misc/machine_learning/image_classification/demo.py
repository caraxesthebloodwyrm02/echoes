...
def show_predictions(model_path, dataset_name='cifar10', num_samples=5, data_dir='./data'):
    ...
    if dataset_name == 'cifar10':
        ...
        dataset = datasets.FashionMNIST(data_dir, train=False, download=True, transform=transform)
    else:
