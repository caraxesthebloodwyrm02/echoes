...
assert_type(
    def_gen.integers(I_u8_low_like, ..., dtype="u8", endpoint=True),
...
assert_type(
    def_gen.integers(I_u8_low_like, ..., dtype="uint64", endpoint=True),
    npt.NDArray[np.uint64],
)
...
assert_type(
    def_gen.integers(I_u8_low_like, ..., dtype=np.uint64, endpoint=True),
    npt.NDArray[np.uint64],
)
...
assert_type(def_gen.integers(-..., ..., dtype="i8", endpoint=True), np.int64)
assert_type(
    def_gen.integers(I_i8_low_like, ..., dtype="i8", endpoint=True),
    npt.NDArray[np.int64],
)
...
assert_type(def_gen.integers(-..., ..., dtype="int64", endpoint=True), np.int64)
assert_type(
    def_gen.integers(I_i8_low_like, ..., dtype="int64", endpoint=True),
    npt.NDArray[np.int64],
)
...
assert_type(def_gen.integers(-..., ..., dtype=np.int64, endpoint=True), np.int64)
assert_type(
    def_gen.integers(I_i8_low_like, ..., dtype=np.int64, endpoint=True),
    npt.NDArray[np.int64],
)
