...
type LineReturn_ChunkCombinedCode = tuple[
    list[PointArray | None], list[CodeArray | None]
]
type LineReturn_ChunkCombinedOffset = tuple[
    list[PointArray | None], list[OffsetArray | None]
]
type LineReturn_ChunkCombinedNan = tuple[list[PointArray | None]]
type LineReturn_Chunk = (
