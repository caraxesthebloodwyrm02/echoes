...
class Constraint:
    def __init__(
        ...
        op: Literal["==", "<=", ">="],
        strength: Literal["weak", "medium", "strong", "required"] | float = "required",
        /,
    ) -> None: ...
    ...
    def __or__(
        self,
        other: Literal["weak", "medium", "strong", "required"] | float,
    ) -> Constraint: ...
    def __ror__(
        self,
        other: Literal["weak", "medium", "strong", "required"] | float,
...
class Solver:
    ...
    def addEditVariable(
        self,
        variable: Variable,
        strength: Literal["weak", "medium", "strong", "required"] | float,
        /,
    ) -> None:
