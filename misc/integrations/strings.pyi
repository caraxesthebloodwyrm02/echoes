...
type _StringDTypeOrUnicodeArray = (
...
@overload
def slice(
    a: U_co, start: i_co | None = None, stop: i_co | None = None, /
) -> NDArray[np.str_]: ...
@overload
def slice(
    a: U_co,
...
@overload
def slice(
    a: S_co, start: i_co | None = None, stop: i_co | None = None, /
) -> NDArray[np.bytes_]: ...
@overload
def slice(
    a: S_co,
...
@overload
def slice(
    a: T_co, start: i_co | None = None, stop: i_co | None = None, /
) -> _StringDTypeOrUnicodeArray: ...
@overload
def slice(
    a: T_co,
