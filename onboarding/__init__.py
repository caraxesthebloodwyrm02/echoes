...
class EchoesOnboarding:
    ...
    async def _connect_to_ecosystem(self) -> Dict[str, Any]:
        ...
        try:
            ...
            atmosphere_root = os.path.dirname(
    ...
    async def _initialize_api_integration(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if test_api():
                ...
                # Test a simple chat
                test_response = await chat(
                    "EchoesAI integration test - respond with 'connected'"
                )
                ...
                return {"status": "failed", "error": "API test failed"}
    ...
    async def _sync_with_ecosystem(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"version_synced": False, "error": str(e)}
