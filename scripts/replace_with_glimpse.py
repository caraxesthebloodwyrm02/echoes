...
def update_file_content(content: str, patterns: Dict[str, str]) -> Tuple[str, List[Tuple[str, str, int]]]:
...
def process_file(filepath: Path, patterns: Dict[str, str]) -> List[Tuple[str, str, int]]:
