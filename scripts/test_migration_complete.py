...
def test_both_apis():
    ...
    result1 = assistant1.chat(
        "Calculate 123 + 456 using the calculator tool.", stream=False
    )
    ...
    result2 = assistant2.chat(
        "Calculate 789 + 123 using the calculator tool.", stream=False
    )
    ...
    assistant3 = EchoesAssistantV2(
        enable_streaming=True, enable_tools=False, enable_status=False
    )
