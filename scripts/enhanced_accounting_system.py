    ...
    def generate_enhanced_financial_statement(
        ...
        try:
            ...
            statement = FinancialStatement(
                ...
                tax_optimization_savings=(
                    total_tax * self.config["tax_optimization_savings_rate"]
                    if user_account.tax_optimization_enabled
                    else Decimal("0.00")
                ),
            ...
            return {
                ...
                "financial_statement": {
                    "summary": {
                        ...
                        "effective_tax_rate": (
                            float(total_tax / total_gross) if total_gross > 0 else 0
                        ),
                        "effective_platform_rate": (
                            float(total_platform / total_gross)
                            if total_gross > 0
                            else 0
                        ),
                    },
