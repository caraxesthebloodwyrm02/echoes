...
class SimpleEnhancedProtectionTest:
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                for consent_config in enhanced_consents:
                    ...
                    if consent_result['success']:
                        ...
                        print(f"   ✅ {consent_config['user_id']}: Enhanced consent created successfully")
                    else:
                ...
                print(f"   ✅ Enhanced consent types test: {successful_consents}/{len(enhanced_consents)} successful")
                
        except Exception as e:
            print(f"   ❌ Enhanced consent types test failed: {str(e)}")
            self.test_results.append({"test_name": "Enhanced Consent Types", "error": str(e)})
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                for scenario in privacy_scenarios:
                    ...
                    if account_result['success']:
                        # Process transaction
                        transaction_result = accounting_system.process_enhanced_transaction(
                            user_id=scenario["user_id"],
                        ...
                        if transaction_result['success']:
                            ...
                            print(f"   ✅ {scenario['user_id']}: {scenario['privacy_control'].value} - ${privacy_bonus:.4f} privacy bonus")
                        else:
                ...
                test_result = {
                    ...
                    "average_privacy_bonus": privacy_bonuses_applied / successful_transactions if successful_transactions > 0 else 0
                }
                
                self.test_results.append(test_result)
                print(f"   ✅ Privacy bonuses test: ${privacy_bonuses_applied:.4f} total privacy bonuses distributed")
                
        except Exception as e:
            print(f"   ❌ Privacy control bonuses test failed: {str(e)}")
            self.test_results.append({"test_name": "Privacy Control Bonuses", "error": str(e)})
    ...
    async def test_data_sovereignty_features(self):
        ...
        try:
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                if account_result['success']:
                    ...
                    if consent_result['success']:
                        ...
                        print(f"   ✅ {sovereign_user}: {features_active}/8 sovereignty features active")
                        ...
                        self.test_results.append(test_result)
                        print(f"   ✅ Data sovereignty test: Complete sovereignty achieved")
                    else:
            ...
            self.test_results.append({"test_name": "Data Sovereignty Features", "error": str(e)})
        ...
        try:
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                for user_config in financial_users:
                    ...
                    if account_result['success']:
                        ...
                        if payout_result['success']:
                            ...
                            print(f"   ✅ {user_config['user_id']}: {active_features} security features active")
                        else:
                ...
                test_result = {
                    ...
                    "average_security_features": total_security_features / successful_payouts if successful_payouts > 0 else 0
                }
                
                self.test_results.append(test_result)
                print(f"   ✅ Financial protection test: {successful_payouts}/{len(financial_users)} payouts with enhanced security")
                
        except Exception as e:
            print(f"   ❌ Enhanced financial protection test failed: {str(e)}")
            self.test_results.append({"test_name": "Enhanced Financial Protection", "error": str(e)})
    ...
    async def generate_protection_report(self):
        ...
        try:
            ...
            protection_report["protection_summary"]["successful_tests"] = successful_tests
            protection_report["protection_summary"]["overall_success_rate"] = successful_tests / total_tests if total_tests > 0 else 0
            ...
            print(f"   🔬 Legal Safeguards: {capabilities['legal_safeguards']['enhanced_consent_types']} consent types")
            print(f"   💰 Financial Protection: {capabilities['financial_protection']['enhanced_value_types']} value types")
            print(f"   👑 Data Sovereignty: {capabilities['data_sovereignty']['ownership_rights']} ownership rights")
...
async def run_simple_enhanced_protection_test():
    ...
    try:
        ...
        print(f"• 🔒 Test Success Rate: {successful_tests}/{total_tests} ({successful_tests/total_tests:.1%})")
