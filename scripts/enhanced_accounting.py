...
class CognitiveAccountingSystem:
    ...
    def generate_financial_statement(
        ...
        statement = FinancialStatement(
            ...
            average_joules_per_user=(
                total_joules / unique_users if unique_users > 0 else 0.0
            ),
            average_value_per_user=(
                total_net / unique_users if unique_users > 0 else Decimal("0.00")
            ),
    ...
    def calculate_payout_eligibility(self, user_id: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "last_transaction": (
                max(user_account.transactions) if user_account.transactions else None
            ),
        }
