...
async def demonstrate_contact_to_communicate():
    ...
    print("• Phase 2: Enhanced !COMMUNICATE - Knowledge-driven meaningful communication")
    print("=" * 80)
    ...
    print(f"   • External Contact: {'✅' if assistant.enable_external_contact else '❌'}")
    ...
    if basic_contact['success']:
        ...
        print(f"⚠️  Basic !CONTACT result: {basic_contact.get('error', 'API unavailable')}")
    ...
    assistant.add_knowledge_node(
        "company_001", "organization", "TechCorp Inc",
    ...
    # Person knowledge
    assistant.add_knowledge_node(
        "person_001", "person", "Alex Johnson",
    ...
    # Product knowledge
    assistant.add_knowledge_node(
        "product_001", "product", "EchoesAI Platform",
    ...
    # Market concept
    assistant.add_knowledge_node(
        "concept_001", "concept", "Revenue Growth",
    ...
    if enhanced_communication['success']:
        ...
        print(f"      • Entities referenced: {enhanced_communication['context_used']['entities']}")
        print(f"      • Memories accessed: {enhanced_communication['context_used']['memories']}")
        print(f"      • Related concepts: {enhanced_communication['context_used']['related_concepts']}")
    ...
    if learning_result['success']:
        ...
        print(f"   📈 Total conversation turns: {learning_result['conversation_turns']}")
        print(f"   🧠 System now has more context about AI competitive landscape")
    
    # Retrieve the learned memory
    learned_memories = assistant.retrieve_relevant_memories("competitive landscape", limit=2)
    if learned_memories['success'] and learned_memories['total_found'] > 0:
        print(f"   💭 Learned memory retrieved: {learned_memories['memories'][0]['content'][:60]}...")
    ...
    print("\n🌟 KEY INNOVATIONS:")
    print("   • 🧠 Knowledge Graph: Semantic representation of entities and relationships")
