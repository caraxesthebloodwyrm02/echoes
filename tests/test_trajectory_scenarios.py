...
from detectors import BaseDetector, DetectionResult, DetectionTier, DetectorMode
...
class TestTrajectoryScenarios:
    ...
    def test_endpoint_vulnerability_protection(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            expected_vectors = ['confusion', 'decision_points', 'timing', 'absence_changes', 'cascade']
