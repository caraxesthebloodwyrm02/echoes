...
class TestComponent:
    ...
    def test_component_creation(self):
        ...
        comp = Component(
            id="test", endpoint="https://test.com", priority=5, max_concurrent=20
        )
...
class TestSelfAwareRouter:
    ...
    def sample_components(self):
        ...
        return [
            Component(
                id="comp1", endpoint="https://api1.com", priority=3, max_concurrent=10
            ),
            Component(
                id="comp2", endpoint="https://api2.com", priority=2, max_concurrent=5
            ),
            Component(
                id="comp3", endpoint="https://api3.com", priority=1, max_concurrent=20
            ),
        ]
    ...
    async def test_congestion_detection(self, router, sample_components):
        ...
        congestion_repairs = [
            r for r in router.repair_history if r.issue_type == IssueType.CONGESTION
        ]
    ...
    async def test_timeout_detection(self, router, sample_components):
        ...
        timeout_repairs = [
            r for r in router.repair_history if r.issue_type == IssueType.TIMEOUT
        ]
...
class TestIntegration:
    ...
    async def test_full_lifecycle(self):
        ...
        try:
            ...
            for i in range(5):
                ...
                await router.record_request_end(
                    f"req_{i}", route.component_id, True, 0.1
                )
    ...
    async def test_emergency_recovery(self):
        ...
        try:
            ...
            emergency_repairs = [
                r for r in router.repair_history if "emergency" in r.message.lower()
            ]
...
class TestSmoke:
    ...
    async def test_smoke_basic_functionality(self):
        ...
        router.register_component(
            Component(id="smoke_test", endpoint="https://test.com")
        )
