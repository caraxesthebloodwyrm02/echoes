...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('test_ucr.log'),
...
class TestUCR(unittest.TestCase):
    ...
    def test_ucr_initialization(self):
        ...
        try:
            ...
            self.assertTrue(hasattr(ucr, 'active_env'), "UCR should have active_env attribute")
    ...
    def test_environment_management(self):
        ...
        try:
            ...
            self.assertEqual(ucr.active_env['name'], TEST_ENV_NAME, 
