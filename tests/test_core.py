...
def test_logger_levels(caplog):
    ...
    assert any(record.levelname == "INFO" and "info message" in record.message for record in caplog.records)
    assert any(record.levelname == "ERROR" and "error message" in record.message for record in caplog.records)
    assert any(record.levelname == "WARNING" and "warning message" in record.message for record in caplog.records)
