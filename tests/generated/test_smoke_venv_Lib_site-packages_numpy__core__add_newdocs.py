# Generated smoke test for venv.Lib.site-packages.numpy._core._add_newdocs
import importlib
import sys
...
COMMON_PATCHES = [
    # ('venv.Lib.site-packages.numpy._core._add_newdocs.OpenAIClient', 'mock.Mock'),
    # ('venv.Lib.site-packages.numpy._core._add_newdocs.SomeDBClient', 'mock.Mock'),
]
...
def test_import_and_basic_init():
    ...
    try:
        mod = importlib.import_module("venv.Lib.site-packages.numpy._core._add_newdocs")
    finally:
        mock.patch.stopall()
