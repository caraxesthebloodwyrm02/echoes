...
class TestECommerceDemoCredibility(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        print("="*80)
        cls.assistant = EchoesAssistantV2(enable_tools=True, enable_rag=False, 
                                         enable_streaming=False, enable_status=False)
    ...
    def test_02_cost_savings_calculation(self):
        ...
        self.assertAlmostEqual(expected_loss, 2304, delta=1, 
                              msg="Low stock calculation should be accurate")
        ...
        self.assertEqual(expected_holding_cost, 350,
                        msg="Overstock calculation should be accurate")
    ...
    def test_03_revenue_opportunity_identification(self):
        ...
        self.assertEqual(potential_recovery, 34200,
        ...
        self.assertEqual(aov_opportunity, 30000,
                        msg="AOV increase opportunity calculation accurate")
...
class TestInvestmentAdvisorCredibility(unittest.TestCase):
    ...
    def test_02_alpha_generation_calculation(self):
        ...
        self.assertAlmostEqual(alpha_percentage, 7.62, places=1, 
                              msg="Alpha percentage should be ~7.6%")
    ...
    def test_03_expected_return_validation(self):
        ...
        self.assertAlmostEqual(total_expected_return, 0.2512, places=3,
                              msg="Total expected return should be ~25.1%")
        self.assertAlmostEqual(expected_portfolio_value, 625_600_000, delta=100000,
    ...
    def test_04_market_analysis_workflow(self):
        ...
        result = self.assistant.run_workflow(
            "data_enrichment",
            topic="Analyze market conditions",
            context={"test": True}
        )
...
class TestSpaceResearchCredibility(unittest.TestCase):
    ...
    def test_01_trajectory_optimization_calculation(self):
        ...
        self.assertGreater(fuel_savings_cost, 700_000_000, 
                          "Fuel savings should be substantial")
    ...
    def test_02_life_support_mass_reduction(self):
        ...
        self.assertAlmostEqual(reduction, 0.506, places=2,
                              msg="Mass reduction should be ~50%")
    ...
    def test_03_propulsion_efficiency_gains(self):
        ...
        self.assertAlmostEqual(optimized_propellant, 38250, delta=1,
                              msg="Optimized propellant should be ~38,250 kg")
        self.assertAlmostEqual(savings, 6750, delta=1,
                              msg="Savings should be ~7,000 kg")
    ...
    def test_04_total_cost_savings_validation(self):
        ...
        self.assertEqual(total_savings, 2_700_000_000, 
                        "Total savings should be $2.7B")
        
        original_cost = 4_500_000_000
        savings_percentage = (total_savings / original_cost) * 100
        
        self.assertAlmostEqual(savings_percentage, 60, delta=5,
...
class TestOverallSystemCredibility(unittest.TestCase):
    ...
    def test_01_knowledge_management_persistence(self):
        ...
        print(f"  ✓ Knowledge entries created: 2")
    ...
    def test_03_error_handling_robustness(self):
        ...
        print(f"  ✓ Invalid workflow handled gracefully")
    ...
    def test_05_combined_business_value(self):
        ...
        self.assertEqual(total_value, 2_826_525_368, 
                        "Combined value should be ~$2.83B")
...
class TestDemoExecutionIntegrity(unittest.TestCase):
    ...
    def test_01_ecommerce_demo_runs(self):
        ...
        try:
            ...
            self.assertTrue(hasattr(demo_business_scenario, 'BusinessScenarioDemo'),
                          "Demo class should exist")
            self.assertTrue(hasattr(demo_business_scenario, 'run_business_demo'),
                          "Run function should exist")
            print(f"  ✓ E-commerce demo imports successfully")
            print(f"  ✓ Demo class and functions exist")
    ...
    def test_02_investment_demo_runs(self):
        ...
        try:
            ...
            self.assertTrue(hasattr(demo_investment_advisor, 'InvestmentAdvisorDemo'),
                          "Demo class should exist")
            self.assertTrue(hasattr(demo_investment_advisor, 'run_investment_demo'),
                          "Run function should exist")
            print(f"  ✓ Investment demo imports successfully")
            print(f"  ✓ Demo class and functions exist")
        except Exception as e:
    ...
    def test_03_space_demo_runs(self):
        ...
        try:
            ...
            self.assertTrue(hasattr(demo_space_research, 'SpaceResearchDemo'),
                          "Demo class should exist")
            self.assertTrue(hasattr(demo_space_research, 'run_space_research_demo'),
                          "Run function should exist")
            print(f"  ✓ Space research demo imports successfully")
            print(f"  ✓ Demo class and functions exist")
        except Exception as e:
