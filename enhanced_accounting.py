...
class EnhancedAccountingSystem:
    ...
    def record_value(self, value_type: ValueType, amount: float, unit: str, description: str, metadata: Optional[Dict[str, Any]] = None) -> str:
    ...
    def calculate_roi(self, value_type: ValueType) -> Dict[str, float]:
        ...
        if invested == 0:
            return {"roi": float('inf'), "total_invested": 0.0, "total_returned": returned}
    ...
    def generate_report(self, period: Optional[AccountingPeriod] = None) -> Dict[str, Any]:
