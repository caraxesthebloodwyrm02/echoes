...
def demo_thought_tracking():
    ...
    conversation_flow = [
        ("I'm having trouble with my Python application", ThoughtType.OBSERVATION, ["Python", "application"]),
        ("The code is throwing an ImportError when I try to import pandas", ThoughtType.ANALYSIS, ["ImportError", "pandas"]),
        ("Maybe pandas is not installed in my virtual environment", ThoughtType.HYPOTHESIS, ["pandas", "virtual environment"]),
        ("Let me check if pandas is installed using pip list", ThoughtType.ACTION, ["pip", "pandas"]),
        ("I can see pandas is not in the installed packages", ThoughtType.OBSERVATION, ["pandas", "packages"]),
        ("I should install pandas using pip install pandas", ThoughtType.DECISION, ["pip", "pandas"]),
        ("After installing pandas, the ImportError should be resolved", ThoughtType.CONCLUSION, ["pandas", "ImportError"]),
    ]
