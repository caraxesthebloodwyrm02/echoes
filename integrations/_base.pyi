...
class _AxesBase(martist.Artist):
    ...
    @overload
    def axis(
        self, arg: tuple[float, float, float, float] | bool | str | None = ..., /, *, emit: bool = ...
    ...
    def margins(
        self, *margins: float, x: float | None = ..., y: float | None = ..., tight: bool | None = ...
    ...
    def set_xticklabels(
        self, labels: Iterable[str | Text], *, minor: bool = ..., fontdict: dict[str, Any] | None = ..., **kwargs
    ) -> list[Text]: ...
