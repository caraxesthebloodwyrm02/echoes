...
class FigureBase(Artist):
    ...
    @overload
    def add_axes(
        self, rect: tuple[float, float, float, float], projection: None | str = ..., polar: bool = ..., **kwargs
    ) -> Axes: ...
    ...
    @overload
    def add_subplot(self, nrows: int, ncols: int, index: int | tuple[int, int], **kwargs: Any) -> Axes: ...
    @overload
...
class Figure(FigureBase):
    ...
    def set_layout_engine(
        self, layout: Literal["constrained", "compressed", "tight", "none"] | LayoutEngine | None = ..., **kwargs
    ) -> None: ...
