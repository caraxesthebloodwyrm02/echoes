...
def demo_pressure_levels():
    ...
    for level in [PressureLevel.LOW, PressureLevel.MEDIUM, PressureLevel.HIGH, 
                  PressureLevel.CRITICAL, PressureLevel.OVERWHELMED]:
...
def demo_pressure_management():
    ...
    for i in range(5):
        ...
        print(f"  Step {i+1}: {summary['current_level'].title()} pressure "
