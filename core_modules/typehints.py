        ...
        if callable(obj):
            ...
            for param in sig.parameters.values():
                if param.annotation is not param.empty:
                    annotation[param.name] = stringify_annotation(param.annotation, mode, short_literals=short_literals)
            if sig.return_annotation is not sig.empty:
                annotation["return"] = stringify_annotation(sig.return_annotation, mode, short_literals=short_literals)
