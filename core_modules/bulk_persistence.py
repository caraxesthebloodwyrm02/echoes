...
class BulkORMUpdate(BulkUDCompileState, UpdateDMLState):
    ...
    def _apply_update_set_values_to_objects(
        ...
        to_prefetch = {
            ...
            if c.key in effective_params and c in mapper._columntoproperty and c.key not in evaluated_keys
        }
        to_expire = {
        ...
        for obj, state, dict_ in matched_objects:
            ...
            dict_.update({col_to_prop: effective_params[c_key] for col_to_prop, c_key in prefetch_transfer})
