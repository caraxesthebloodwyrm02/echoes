def _svds_arpack_doc(
    A, k=6, ncv=None, tol=0, which="LM", v0=None, maxiter=None, return_singular_vectors=True, solver="arpack", rng=None
):
    """
...
def _svds_lobpcg_doc(
    A, k=6, ncv=None, tol=0, which="LM", v0=None, maxiter=None, return_singular_vectors=True, solver="lobpcg", rng=None
):
    """
...
def _svds_propack_doc(
    A, k=6, ncv=None, tol=0, which="LM", v0=None, maxiter=None, return_singular_vectors=True, solver="propack", rng=None
):
    """
