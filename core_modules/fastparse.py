...
def parse(
    ...
    try:
        ...
        try:
            ...
            errors.report(-1, -1, "Source expression too complex to parse", blocker=False, code=codes.MISC)
    ...
    def translate_type_params(self, type_params: list[Any]) -> list[TypeParam]:
        ...
        for p in type_params:
            ...
            if isinstance(p, ast_ParamSpec):  # type: ignore[misc]
                ...
                explicit_type_params.append(TypeParam(p.name, TYPE_VAR_TUPLE_KIND, None, [], default))
            else:
