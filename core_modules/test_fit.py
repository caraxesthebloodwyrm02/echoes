    ...
    for fit_size in fit_sizes:
        ...
        with np.errstate(all="ignore"):
            ...
            if method == "MLE" and distname not in fail_interval_censored:
                ...
                msg = "Different results fitting interval-censored" f" data: {distfn.name}: est={est} est2={est2}"
...
@pytest.mark.parametrize(
    "dist, params", [(stats.norm, (0.5, 2.5)), (stats.binom, (10, 0.3, 2))]  # type: ignore[attr-defined]
...
class TestFit:
    ...
    def test_arcsine(self):
        ...
        assert_nlff_less_or_close(dist, data, res.params, shapes, nlff_name="_penalized_nlpsf", **self.tols)
...
class TestGoodnessOfFit:
    ...
    def test_against_filliben_norm(self):
        ...
        res = stats.goodness_of_fit(stats.norm, y, known_params=known_params, statistic="filliben", rng=rng)
    ...
    def test_filliben_property(self):
        ...
        known_params = {"loc": 0, "scale": 1}
        ref = stats.goodness_of_fit(stats.norm, x, known_params=known_params, statistic="filliben", rng=rng)
    ...
    def test_against_filliben_norm_table(self, case):
        ...
        x = rng.random(n)
        known_params = {"loc": 0, "scale": 1}
        res = stats.goodness_of_fit(stats.norm, x, known_params=known_params, statistic="filliben", rng=rng)
    ...
    @pytest.mark.xslow
    @pytest.mark.parametrize(
        "case", [(5, 0.95772790260469, 0.4755), (6, 0.95398832257958, 0.3848), (7, 0.9432692889277, 0.2328)]
    )
    ...
    def test_custom_statistic(self):
        ...
        result = goodness_of_fit(stats.expon, data, known_params={"loc": 0, "scale": 1}, statistic=greenwood, rng=rng)
