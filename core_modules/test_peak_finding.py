...
class TestPeakWidths:
    ...
    def test_intersection_rules(self):
        ...
        xp_assert_close(peak_widths(x, peaks=[5], rel_height=2 / 3), [(4.0,), (1.0,), (3.0,), (7.0,)])
...
class TestFindPeaks:
    ...
    def test_threshold_condition(self):
        ...
        xp_assert_equal(find_peaks(x, threshold=(2, 4))[0], np.array([], dtype=int), check_dtype=False)
...
class TestFindPeaksCwt:
    ...
    def test_find_peaks_exact(self):
        ...
        xp_assert_equal(
            found_locs, act_locs, check_dtype=False, err_msg="Found maximum locations did not equal those expected"
        )
    ...
    def test_find_peaks_withnoise(self):
        ...
        np.testing.assert_array_less(diffs, max_diffs, "Maximum location differed" + f"by more than {max_diffs}")
