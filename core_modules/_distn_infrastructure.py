...
class rv_generic:
    ...
    def _construct_doc(self, docdict, shapes_vals=None):
        ...
        for i in range(2):
            ...
            try:
                ...
                raise Exception("Unable to construct docstring for " f'distribution "{self.name}": {repr(e)}') from e
    ...
    def _argcheck_rvs(self, *args, **kwargs):
        ...
        if not ok:
            raise ValueError(
                "size does not match the broadcast shape of " f"the parameters. {size}, {size_}, {bcast_shape}"
            )
...
class rv_continuous(rv_generic):
    ...
    **Deepcopying / Pickling**
    ...
    def __init__(
        self, momtype=1, a=None, b=None, xtol=1e-14, badvalue=None, name=None, longname=None, shapes=None, seed=None
    ):
    ...
    **Deepcopying / Pickling**
    ...
    def _entropy(self, *args):
        if hasattr(self, "pk"):
            ...
            _a, _b = self._get_support(*args)
            return _expect(lambda x: entr(self._pmf(x, *args)), _a, _b, self._ppf(0.5, *args), self.inc)
