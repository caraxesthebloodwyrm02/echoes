...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("gpu_test.log"), logging.StreamHandler(sys.stdout)],
...
class GPUModelEvaluator:
    ...
    def generate_gpu_report(self, results: Dict[str, Any]) -> None:
        ...
        for model_name, result in results.items():
            ...
            print(
                f"  Avg Response Time: {result.get('rate_limiting_metrics', {}).get('average_response_time', 0):.2f}s"
            )
...
def main():
    ...
    print("Directories validated. Starting evaluation...")
    sys.stdout.flush()
