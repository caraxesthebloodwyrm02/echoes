...
class Axes3D(Axes):
    ...
    def _set_lim3d(
        self, axis, lower=None, upper=None, *, emit=True, auto=False, view_margin=None, axmin=None, axmax=None
    ):
        """
        Set 3D axis limits.
        """
    ...
    def set_xlim(self, left=None, right=None, *, emit=True, auto=False, view_margin=None, xmin=None, xmax=None):
        ...
        return self._set_lim3d(
            self.xaxis, left, right, emit=emit, auto=auto, view_margin=view_margin, axmin=xmin, axmax=xmax
        )
    ...
    def set_ylim(self, bottom=None, top=None, *, emit=True, auto=False, view_margin=None, ymin=None, ymax=None):
        ...
        """
        return self._set_lim3d(
            self.yaxis, bottom, top, emit=emit, auto=auto, view_margin=view_margin, axmin=ymin, axmax=ymax
        )
    ...
    def set_zlim(self, bottom=None, top=None, *, emit=True, auto=False, view_margin=None, zmin=None, zmax=None):
        ...
        """
        return self._set_lim3d(
            self.zaxis, bottom, top, emit=emit, auto=auto, view_margin=view_margin, axmin=zmin, axmax=zmax
        )
    ...
    def fill_between(
        ...
        **kwargs
        ...
        polyc = art3d.Poly3DCollection(polys, facecolors=facecolors, shade=shade, axlim_clip=axlim_clip, **kwargs)
        self.add_collection(polyc)

        self.auto_scale_xyz([x1, x2], [y1, y2], [z1, z2], had_data)
        return polyc

    def plot_surface(self, X, Y, Z, *, norm=None, vmin=None, vmax=None, lightsource=None, axlim_clip=False, **kwargs):
        """
        ...
        **kwargs
        ...
        if fcolors is not None:
            ...
            polyc = art3d.Poly3DCollection(
                polys, facecolors=color, shade=shade, lightsource=lightsource, axlim_clip=axlim_clip, **kwargs
            )
    ...
    def plot_trisurf(
        self, *args, color=None, norm=None, vmin=None, vmax=None, lightsource=None, axlim_clip=False, **kwargs
    ):
        """
        ...
        **kwargs
        ...
        if cmap:
            ...
            polyc = art3d.Poly3DCollection(
                verts, *args, shade=shade, lightsource=lightsource, facecolors=color, axlim_clip=axlim_clip, **kwargs
            )
    ...
    def add_contour_set(self, cset, extend3d=False, stride=5, zdir="z", offset=None, axlim_clip=False):
        zdir = "-" + zdir
        if extend3d:
            self._3d_extend_contour(cset, stride)
        else:
            art3d.collection_2d_to_3d(
                cset, zs=offset if offset is not None else cset.levels, zdir=zdir, axlim_clip=axlim_clip
            )
    ...
    def scatter(self, xs, ys, zs=0, zdir="z", s=20, c=None, depthshade=True, *args, axlim_clip=False, **kwargs):
        """
        ...
        **kwargs
        ...
        art3d.patch_collection_2d_to_3d(patches, zs=zs, zdir=zdir, depthshade=depthshade, axlim_clip=axlim_clip)
    ...
    def voxels(self, *args, facecolors=None, edgecolors=None, shade=True, lightsource=None, axlim_clip=False, **kwargs):
        """
        ...
        **kwargs
        ...
        for zdir, data, err, lolims, uplims in zip(
            ...
            if nolims.any() and capsize > 0:
                ...
                cap_lo = art3d.Line3D(
                    *lo_caps_xyz, ls="", marker=capmarker[i_zdir], axlim_clip=axlim_clip, **eb_cap_style
                )
                cap_hi = art3d.Line3D(
                    *hi_caps_xyz, ls="", marker=capmarker[i_zdir], axlim_clip=axlim_clip, **eb_cap_style
                )
            ...
            errline = art3d.Line3DCollection(np.array(coorderr).T, axlim_clip=axlim_clip, **eb_lines_style)
