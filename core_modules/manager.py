...
class TestExtensionManager(extension.ExtensionManager):
    ...
    def __init__(self, extensions, namespace="test", invoke_on_load=False, invoke_args=(), invoke_kwds={}):
        super().__init__(
            namespace,
            invoke_on_load,
            invoke_args,
        ...
        warnings.warn("TestExtesionManager has been replaced by make_test_instance()", DeprecationWarning)
