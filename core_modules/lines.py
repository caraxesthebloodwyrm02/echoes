...
def _mark_every_path(markevery, tpath, affine, ax):
    ...
    if isinstance(markevery, tuple):
        if len(markevery) != 2:
            raise ValueError("`markevery` is a tuple but its len is not 2; " f"markevery={markevery}")
...
class AxLine(Line2D):
    ...
    def set_xy2(self, *args, **kwargs):
        ...
        if self._slope is None:
            ...
            raise ValueError(
                "Cannot set an 'xy2' value while 'slope' is set;" " they differ but their functionalities overlap"
            )
    ...
    def set_slope(self, slope):
        ...
        if self._xy2 is None:
            ...
            raise ValueError(
                "Cannot set a 'slope' value while 'xy2' is set;" " they differ but their functionalities overlap"
            )
