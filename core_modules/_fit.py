...
def goodness_of_fit(
    dist, data, *, known_params=None, fit_params=None, guessed_params=None, statistic="ad", n_mc_samples=9999, rng=None
):
    r"""
    ...
    *observed data*. This tends to reduce the value of the statistic for the
    ...
    """
    args = _gof_iv(dist, data, known_params, fit_params, guessed_params, statistic, n_mc_samples, rng)
    (
        dist,
        data,
        fixed_nhd_params,
    ...
    res = stats.monte_carlo_test(
        data, rvs, statistic_fun, vectorized=True, n_resamples=n_mc_samples, axis=-1, alternative=alternative
    )
...
_compare_dict = {"ad": _anderson_darling, "ks": _kolmogorov_smirnov, "cvm": _cramer_von_mises, "filliben": _filliben}
