...
class _LogUniform(ContinuousDistribution):
    ...
    _log_a_param = _RealParameter("log_a", symbol=r"\log(a)", domain=_log_a_domain, typical=(-3, -0.1))
    _log_b_param = _RealParameter("log_b", symbol=r"\log(b)", domain=_log_b_domain, typical=(0.1, 3))
    ...
    _parameterizations = [_Parameterization(_log_a_param, _log_b_param), _Parameterization(_a_param, _b_param)]
    _variable = _x_param
