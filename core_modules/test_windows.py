...
class RemoteProcessTestCase(PsutilTestCase):
    ...
    def setUp(self):
        ...
        self.proc32 = self.spawn_subproc([self.python32] + self.test_args, env=env, stdin=subprocess.PIPE)
        self.proc64 = self.spawn_subproc([self.python64] + self.test_args, env=env, stdin=subprocess.PIPE)
