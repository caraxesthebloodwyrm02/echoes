...
class TestNNLS:
    ...
    def test_nnls_gh21021_ex1(self):
        ...
        b = [18.036779281222124, -18.126530733870887, 13.535652034584029, -2.6654275476795966, 9.166315328199575]

        # Obtained from matlab's lstnonneg
        des_sol = np.array(
            [0.0, 118.017802006619, 45.1996532316584, 102.62156313537, 0.0, 55.8590204314398, 0.0, 29.7328833253434]
        )
        sol, res = nnls(A, b)
    ...
    def test_nnls_gh21021_ex2(self):
        ...
        b = np.array([24.456141951303913, 28.047143273432333, 41.10526799545987, -1.2078282698324068])
