...
class SVDSCommonTests:
    ...
    def test_svds_diff0_docstring_example(self):
        ...
        def diff0_func_aslo_def(n):
            return LinearOperator(matvec=diff0, matmat=diff0, rmatvec=diff0t, rmatmat=diff0t, shape=(n - 1, n))
    ...
    def test_svds_parameter_tol(self):
        ...
        accuracies = {"propack": [1e-12, 1e-6, 1e-4], "arpack": [2.5e-15, 1e-10, 1e-10], "lobpcg": [2e-12, 4e-2, 2]}
