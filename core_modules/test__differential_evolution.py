...
class TestDifferentialEvolutionSolver:
    ...
    def test_rng_gives_repeatability(self):
        ...
        result2 = differential_evolution(self.quadratic, [(-100, 100)], polish=False, rng=1, tol=0.5)
    ...
    def test_random_generator(self):
        ...
        for init in inits:
            differential_evolution(self.quadratic, [(-100, 100)], polish=False, rng=rng, tol=0.5, init=init)
    ...
    def test_parallel(self):
        ...
        with DifferentialEvolutionSolver(rosen, bounds, updating="deferred", workers=2, popsize=3, tol=0.1) as solver:
            assert solver._mapwrapper.pool is not None
            assert solver._updating == "deferred"
            solver.solve()
    ...
    def test_impossible_constraint(self):
        ...
        solver = DifferentialEvolutionSolver(rosen, [(0, 2), (0, 2)], constraints=(nlc,), popsize=1, rng=1, maxiter=100)
    ...
    def test_L1(self):
        ...
        res = differential_evolution(f, bounds, strategy="best1bin", rng=12345, constraints=(L,), popsize=5, tol=0.01)
        ...
        # using a lower popsize to speed the test up
        res = differential_evolution(f, bounds, strategy="best1bin", rng=1211134, constraints=(L,), popsize=2, tol=0.05)
        ...
        with suppress_warnings() as sup:
            ...
            res = differential_evolution(
                f, bounds, strategy="best1bin", rng=1211134, constraints=constraints, popsize=2, tol=0.05
            )
    ...
    def test_L2(self):
        ...
        with suppress_warnings() as sup:
            sup.filter(UserWarning)
            res = differential_evolution(f, bounds, strategy="best1bin", rng=1234, constraints=constraints)
    ...
    def test_L4(self):
        ...
        with suppress_warnings() as sup:
            sup.filter(UserWarning)
            res = differential_evolution(
                f, bounds, strategy="best1bin", rng=1234, constraints=constraints, popsize=3, tol=0.05
            )
    ...
    def test_L5(self):
        ...
        res = differential_evolution(f, bounds, strategy="rand1bin", rng=1234, constraints=constraints)
    ...
    def test_L6(self):
        ...
        bounds = [(13, 100), (0, 100)]
        constraints = N
        res = differential_evolution(f, bounds, strategy="rand1bin", rng=1234, constraints=constraints, tol=1e-7)
    ...
    def test_integrality(self):
        ...
        res = differential_evolution(func, bounds, args=(dist, x), integrality=integrality, polish=False, rng=rng)
        ...
        res2 = differential_evolution(func, bounds, args=(dist, x), integrality=integrality, polish=True, rng=rng)
    ...
    def test_vectorized(self):
        ...
        res2 = differential_evolution(rosen_vec, bounds, vectorized=True, updating="deferred", rng=1)
    ...
    def test_vectorized_constraints(self):
        ...
        res1 = differential_evolution(rosen, bounds, updating="deferred", rng=1, constraints=[nlc1, nlc2], polish=False)
        res2 = differential_evolution(
            rosen_vec, bounds, vectorized=True, updating="deferred", rng=1, constraints=[nlc1, nlc2], polish=False
        )
        # the two minimisation runs should be functionally equivalent
        assert_allclose(res1.x, res2.x)
    ...
    def test_constraint_violation_error_message(self):
        ...
        result = differential_evolution(
            func, bounds=[(-1, 2), (-1, 1)], constraints=[c0, c1], maxiter=10, polish=False, rng=864197532
        )
    ...
    def test_strategy_fn(self):
        ...
        res = differential_evolution(rosen, bounds, strategy=custom_strategy_fn, updating="deferred")
        assert res.success
