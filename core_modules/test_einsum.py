...
class TestEinsum:
    ...
    def test_einsum_sorting_behavior(self):
        ...
        assert_equal(
            ...
            err_msg=("Output indices for n=26 are not lexicographically sorted: " f"{output_indices1}"),
        )
        ...
        assert_equal(
            ...
            err_msg=("Output indices for n=27 are not lexicographically sorted: " f"{output_indices2}"),
        )
