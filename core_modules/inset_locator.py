...
def _add_inset_axes(parent_axes, axes_class, axes_kwargs, axes_locator):
    ...
    inset_axes = axes_class(
        fig, parent_axes.get_position(), **{"navigate": False, **axes_kwargs, "axes_locator": axes_locator}
    )
...
def inset_axes(
    ...
    *parent_axes.bbox*) is transformed by the bbox_transform (the default
    ...
    return _add_inset_axes(
        ...
        axes_class,
        axes_kwargs,
        AnchoredSizeLocator(bbox_to_anchor, width, height, loc=loc, bbox_transform=bbox_transform, borderpad=borderpad),
    )
