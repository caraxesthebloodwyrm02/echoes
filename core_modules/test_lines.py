...
@image_comparison(["drawstyle_variants.png"], remove_text=True, tol=0 if platform.machine() == "x86_64" else 0.03)
...
@image_comparison(
    ["line_collection_dashes"], remove_text=True, style="mpl20", tol=0 if platform.machine() == "x86_64" else 0.65
)
