        ...
        match whence:
            ...
            case _:
                raise io.UnsupportedOperation(
                    "SeekEmulatingReader was asked to emulate" " a seek operation it does not support."
                )
        return self.pos
...
def _read_data_chunk(
    fid, format_tag, channels, bit_depth, is_big_endian, is_rf64, block_align, mmap=False, rf64_chunk_size=None
):
    """
    Notes
    -----
...
def _read_riff_chunk(fid):
    ...
    if str1 == b"RIFF":
        ...
        raise ValueError(f"File format {repr(str1)} not understood. Only " "'RIFF', 'RIFX', and 'RF64' supported.")
    # Size of entire file
    if not is_rf64:
        ...
        while fid.tell() < file_size:
            ...
            if chunk_id == b"fmt ":
                ...
                data = _read_data_chunk(
                    fid, format_tag, channels, bit_depth, is_big_endian, is_rf64, block_align, mmap, rf64_chunk_size
                )
