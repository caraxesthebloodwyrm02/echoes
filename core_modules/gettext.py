...
class Message:
    ...
    def __repr__(self) -> str:
        return "Message(" f"text={self.text!r}, locations={self.locations!r}, uuids={self.uuids!r}" ")"
...
class MessageCatalogBuilder(I18nBuilder):
    ...
    def finish(self) -> None:
        ...
        for textdomain, catalog in status_iterator(
            ...
            template_path = [self.app.srcdir / rel_path for rel_path in self.config.templates_path]
...
def setup(app: Sphinx) -> ExtensionMetadata:
    ...
    app.add_config_value("gettext_compact", True, "gettext", types=frozenset({bool, str}))
