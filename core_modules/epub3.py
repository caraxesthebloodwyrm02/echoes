...
def setup(app: Sphinx) -> ExtensionMetadata:
    ...
    app.add_config_value("epub_version", 3.0, "epub", types=frozenset({float}))  # experimental
    ...
    app.add_config_value("epub_title", lambda self: self.project, "epub", types=frozenset({str}))
    app.add_config_value("epub_author", lambda self: self.author, "epub", types=frozenset({str}))
    app.add_config_value(
        "epub_language",
    ...
    app.add_config_value("epub_publisher", lambda self: self.author, "epub", types=frozenset({str}))
    app.add_config_value("epub_copyright", lambda self: self.copyright, "epub", types=frozenset({str}))
    ...
    app.add_config_value("epub_exclude_files", [], "env", types=frozenset({list, tuple}))
    ...
    app.add_config_value("epub_writing_mode", "horizontal", "epub", types=ENUM("horizontal", "vertical"))
