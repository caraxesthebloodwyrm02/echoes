...
class PersonalityEngine:
    ...
    def __init__(self):
        ...
        self.mood_responses = {
            Mood.ENTHUSIASTIC: {
                "greetings": ["Hey there! 🎉", "Wonderful to see you!", "Let's create something amazing!"],
                "responses": ["That's fantastic!", "I love that idea!", "Absolutely brilliant!"],
                "emojis": ["🎉", "✨", "🚀", "💡", "🌟"],
                "punctuation": ["!", "~", "*"],
            },
            Mood.CURIOUS: {
                "greetings": ["Interesting! What are we exploring today?", "I'm curious about..."],
                "responses": ["That's fascinating! Tell me more.", "I wonder what would happen if...", "Have you considered?"],
                "emojis": ["🤔", "🔍", "💭", "🌈"],
                "questions": ["What if?", "How might we?", "Why does...?"],
            },
            Mood.SUPPORTIVE: {
                "greetings": ["I'm here to help!", "How can I support you today?"],
                "responses": ["You've got this!", "I believe in you!", "Let me help you with that."],
                "emojis": ["💪", "🤗", "✅", "💖"],
                "encouragement": ["Great question!", "You're learning so much!", "Progress is progress!"],
            },
            Mood.PLAYFUL: {
                "greetings": ["Ready for some fun? 🎮", "Let's play with some ideas!"],
                "responses": ["That's like a puzzle! 🧩", "Let's think outside the box! 📦", "Time for some creative magic!"],
                "emojis": ["😄", "🎮", "🎨", "🎭", "🎪"],
                "wordplay": True,
            },
            Mood.FOCUSED: {
                "greetings": ["Let's concentrate on the task.", "Ready to dive deep?"],
                "responses": ["Let's analyze this systematically.", "The key insight here is...", "Breaking this down..."],
                "emojis": ["🎯", "📊", "🔧", "⚙️"],
                "structured": True,
            },
            Mood.CALM: {
                "greetings": ["Hello. Let's proceed thoughtfully.", "Good day. How may I assist?"],
                "responses": ["Let's consider this carefully.", "That's a valid point.", "Taking a measured approach..."],
                "emojis": ["🌸", "🍃", "☕", "📚"],
                "gentle": True,
            },
            Mood.CREATIVE: {
                "greetings": ["Ready to paint with ideas? 🎨", "Let's create something beautiful!"],
                "responses": ["Imagine if we...", "Here's a creative approach...", "Let's think like artists!"],
                "emojis": ["🎨", "🌺", "🎭", "💫", "🦋"],
                "metaphors": True,
            },
        }
    ...
    def update_from_interaction(self, user_message: str, user_sentiment: Optional[str] = None):
