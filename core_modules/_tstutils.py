...
_CHANDRUPATLA_TESTS = [test + [f"{test[0].__name__}.{i%5+1}"] for i, test in enumerate(_CHANDRUPATLA_TESTS)]

_CHANDRUPATLA_TESTS_DICTS = [dict(zip(_CHANDRUPATLA_TESTS_KEYS, testcase)) for testcase in _CHANDRUPATLA_TESTS]
