...
class TestJWTHandler:
    ...
    def test_expired_token(self):
        ...
        handler = JWTHandler(secret_key="test-secret")
        token = handler.create_access_token({"sub": "user123"}, expires_delta=timedelta(seconds=-1))  # Already expired
    ...
    def test_refresh_access_token(self):
        ...
        refresh_token = handler.create_refresh_token(
            {"sub": "user123", "role": "admin", "platforms": ["echoes", "turbo"]}
        )
...
class TestAPIKeyManager:
    ...
    def test_generate_api_key(self, temp_storage):
        ...
        manager = APIKeyManager(storage_path=temp_storage)
        api_key = manager.generate_key(name="Test Key", role="researcher", platforms=["glimpse", "turbo"])
...
class TestIntegrationScenarios:
    ...
    def test_complete_jwt_workflow(self):
        ...
        user_data = {"sub": "user123", "role": "researcher", "platforms": ["glimpse", "turbo"]}
    ...
    def test_complete_api_key_workflow(self, temp_storage):
        ...
        api_key = manager.generate_key(name="Research Team", role="researcher", platforms=["glimpse", "turbo"])
