...
from mpl_toolkits.axes_grid1.inset_locator import zoomed_inset_axes, mark_inset, inset_axes, BboxConnectorPatch
...
def test_anchored_artists():
    ...
    box = AnchoredAuxTransformBox(ax.transData, loc="lower left", frameon=True, pad=0.5, borderpad=0.4)
