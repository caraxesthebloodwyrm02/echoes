...
class TelephoneBooth:
    ...
    def start_conversation(self, initial_question: str) -> Dict[str, Any]:
        ...
        if self.connection_status != "connected":
            return {"status": "error", "message": "Connection not established. Call initiate_connection() first."}
    ...
    def _generate_response(self, question: str) -> str:
        ...
        if "communication" in question_lower:
            ...
            return (
                f"Processing your question about: {question}. Additional context may be needed for detailed response."
            )
