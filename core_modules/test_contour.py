...
@image_comparison(
    ["contour_manual_colors_and_levels.png"], remove_text=True, tol=0 if platform.machine() == "x86_64" else 0.018
)
...
@pytest.mark.parametrize(
    "color, extend",
    [("darkred", "neither"), ("darkred", "both"), (("r", 0.5), "neither"), ((0.1, 0.2, 0.5, 0.3), "neither")],
)
...
@image_comparison(
    ["contour_addlines.png"], remove_text=True, style="mpl20", tol=0.03 if platform.machine() == "x86_64" else 0.15
)
...
def test_all_nan():
    ...
    assert_array_almost_equal(
        plt.contour(x).levels, [-1e-13, -7.5e-14, -5e-14, -2.4e-14, 0.0, 2.4e-14, 5e-14, 7.5e-14, 1e-13]
    )
