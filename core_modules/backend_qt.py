...
class FigureCanvasQT(FigureCanvasBase, QtWidgets.QWidget):
    ...
    def _mpl_buttons(buttons):
        ...
        return {button for mask, button in FigureCanvasQT.buttond.items() if _to_int(mask) & buttons}
        ...
        if self.coordinates:
            ...
            self.locLabel.setAlignment(
                QtCore.Qt.AlignmentFlag(
                    _to_int(QtCore.Qt.AlignmentFlag.AlignRight) | _to_int(QtCore.Qt.AlignmentFlag.AlignVCenter)
                )
            )
