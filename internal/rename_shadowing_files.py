...
def get_stdlib_modules():
    ...
    additional_stdlib = {
        '_pytest', 'pytest', 'numpy', 'pandas', 'matplotlib', 'scipy', 'sklearn',
        'tensorflow', 'torch', 'requests', 'flask', 'django', 'sqlalchemy', 'pydantic',
        'typing_extensions', 'pytest_cov', 'coverage', 'pylint', 'flake8', 'mypy',
        'black', 'isort', 'mypy_extensions', 'docutils', 'sphinx', 'setuptools',
        'pip', 'wheel', 'virtualenv', 'pipenv', 'poetry'
    }
    
    # Add common test module names
    test_modules = {
        'conftest', 'test_utils', 'test_helpers', 'fixtures', 'factories',
        'mocks', 'fakes', 'stubs', 'helpers', 'utils'
    }
