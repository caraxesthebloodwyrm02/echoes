...
common_packages = {
    ...
    'djongo', 'django-mongodb-engine', 'cassandra-driver', 'scylla-driver',
    ...
    'firebase', 'firestore', 'realtime-database', 'cloud-functions', 'app-engine',
...
E:\Projects\Echoes\core\vengine_cpy.py
E:\Projects\Echoes\core\vengine_gen.py
