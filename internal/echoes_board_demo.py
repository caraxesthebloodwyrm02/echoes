...
class PresentationDemo:
    ...
    def run_demo(self):
        ...
        print(f"Live Demonstration | {self.start_time.strftime('%B %d, %Y at %I:%M %p')}")
        ...
        self.print_section("LIVE DEMONSTRATION: BUSINESS OPTIMIZATION IN REAL-TIME", "🚀")
        ...
        inventory_data = [
            ...
            {"product": "Wireless Mouse Elite", "units": 25, "velocity": "critical_low"},
        ...
        for item in inventory_data:
            ...
            print(f"  {status} {item['product']}: {item['units']} units [{item['velocity']}]")
            time.sleep(0.3)
        ...
        print("[Analyzing conversion funnels, pricing elasticity, and customer behavior...]")
        self.pause(2)
        ...
        print("[Synthesizing insights across inventory, revenue, and competitive landscape...]")
        self.pause(1.5)
        ...
        roadmap = [
            {
                ...
                "kpis": ["Holding cost reduction", "Stockout prevention", "Working capital efficiency"]
            },
            {
                "initiative": "Cart Recovery Engine",
        ...
        print(f"  Profit Margin Improvement:      +{profit_margin_gain:.1f} percentage points")
        self.pause(2.5)
