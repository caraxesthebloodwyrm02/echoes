...
class FunctionScope(Scope):
    ...
    usesLocals = False
    alwaysUsed = {"__tracebackhide__", "__traceback_info__", "__traceback_supplement__", "__debuggerskip__"}
...
class Checker:
    ...
    def __init__(
        self, tree, filename="(none)", builtins=None, withDoctest="PYFLAKES_DOCTEST" in os.environ, file_tokens=()
    ):
        self._nodeHandlers = {}
