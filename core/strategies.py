...
class SubqueryLoader(PostLoader):
    ...
    def create_row_processor(
        ...
        if loadopt and context.compile_state.statement is not None and context.compile_state.statement.is_dml:
...
class JoinedLoader(AbstractRelationshipLoader):
    ...
    def _create_eager_join(
        ...
        if attach_on_outside:
            ...
            eagerjoin = self._splice_nested_inner_join(path, path[-2], towrap, clauses, onclause, extra_join_criteria)
    ...
    def _splice_nested_inner_join(
        ...
        if isinstance(join_obj, sql.selectable.FromGrouping):
            ...
            target_join = self._splice_nested_inner_join(
                ...
                onclause,
                extra_criteria,
                entity_inside_join_structure=(join_right_path[-1].mapper if join_right_path is not None else None),
            )
