...
class TestShgoArguments:
    ...
    def test_7_1_minkwargs(self):
        ...
        for solver in ["COBYLA", "COBYQA", "SLSQP"]:
            ...
            run_test(test3_1, n=100, test_atol=1e-3, minimizer_kwargs=minimizer_kwargs, sampling_method="sobol")
    ...
    def test_7_3_minkwargs(self):
        ...
        for solver in [
            ...
            logging.info("=" * 100)
            run_test(test1_1, n=100, test_atol=1e-3, minimizer_kwargs=minimizer_kwargs, sampling_method="sobol")
    ...
    def test_21_1_jac_true(self):
        ...
        res = shgo(
            func, bounds=bounds, sampling_method="sobol", minimizer_kwargs={"method": "SLSQP"}, options={"jac": True}
        )
        assert res.success
        assert_allclose(res.fun, ref.fun)
        assert_allclose(res.x, ref.x, atol=1e-15)
