...
from scipy._lib._array_api import _asarray, array_namespace, is_lazy_array, xp_capabilities, xp_copy, xp_size
...
@xp_capabilities(cpu_only=True, reason="uses spatial.distance.cdist", jax_jit=False, allow_dask_compute=True)
...
@xp_capabilities(cpu_only=True, jax_jit=False, allow_dask_compute=True)
@_transition_to_rng("seed")
def kmeans2(data, k, iter=10, thresh=1e-5, minit="random", missing="warn", check_finite=True, *, rng=None):
    """
