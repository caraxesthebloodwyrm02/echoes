...
def create_figure():
    ...
    plt.text(0.9, 0.5, "unicode (ü, °, \N{Section Sign}) and math ($\\mu_i = x_i^2$)", ha="right", fontsize=20)
...
def test_document_font_size():
    ...
    plt.figure()
    plt.plot([], label=r"$this is a very very very long math label a \times b + 10^{-3}$ " r"and some text")
