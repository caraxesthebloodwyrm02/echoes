...
class Legend(Artist):
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(self.shadow, dict):
            ...
            raise ValueError(
                "Legend shadow must be a dict or bool, not " f"{self.shadow!r} of type {type(self.shadow)}."
            )
    ...
    def set_loc(self, loc=None):
        ...
        type_err_message = "loc must be string, coordinate tuple, or" f" an integer 0-10, not {loc!r}"
