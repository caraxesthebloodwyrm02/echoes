...
class TestEntropy:
    ...
    def test_entropy_2d_nondefault_axis(self, xp):
        pk = xp.asarray([[0.1, 0.2], [0.6, 0.3], [0.3, 0.5]])
        qk = xp.asarray([[0.2, 0.1], [0.3, 0.6], [0.5, 0.3]])
        xp_assert_close(stats.entropy(pk, qk, axis=1), xp.asarray([0.23104906, 0.23104906, 0.12770641]))
...
class TestDifferentialEntropy:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            "van es",
            "ebrahimi",
            pytest.param("correa", marks=skip_xp_backends("array_api_strict", reason="Needs fancy indexing.")),
        ],
    )
