...
class TestPlotting:
    ...
    def test_gh_19653(self):
        ...
        expected_segments = np.array(
            [
                [[282.77256, -254.76904], [282.729714, -4544.744698]],
                [[282.77256014, -254.76904029], [430.08561382, 4032.67658742]],
                [[229.26733285, -20.39957514], [-168.17167404, -4291.92545966]],
                [[289.93433364, 5151.40412217], [330.40553385, 9441.18887532]],
            ]
        )
    ...
    def test_gh_19653_smaller_aspect(self):
        ...
        points = np.array(
            [
                [24.059986986012, 10.971011721360075],
        ...
        expected_segments = np.array(
            [
                [[28.274979, 8.335027], [28.270463, -42.19763338]],
                [[28.27497869, 8.33502697], [43.73223829, 56.44555501]],
                [[22.51805823, 11.8621754], [-12.09266506, -24.95694485]],
                [[29.53092448, 78.46952378], [33.82572726, 128.81934455]],
            ]
        )
        assert_allclose(infinite_segments, expected_segments)
