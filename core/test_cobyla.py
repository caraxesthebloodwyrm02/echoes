...
from scipy.optimize import fmin_cobyla, minimize, Bounds, NonlinearConstraint, LinearConstraint, OptimizeResult
...
class TestCobyla:
    ...
    def test_simple(self):
        ...
        x = fmin_cobyla(self.fun, self.x0, [self.con1, self.con2], rhobeg=1, rhoend=1e-5, maxfun=100, disp=1)
    ...
    def test_minimize_simple(self):
        ...
        sol_new = minimize(
            self.fun, self.x0, method="cobyla", constraints=cons, callback=callback_new_syntax, options=self.opts
        )
