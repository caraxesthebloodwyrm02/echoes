...
class TestFFT1D:
    ...
    @pytest.mark.parametrize("op", [np.fft.fftn, np.fft.ifftn, np.fft.rfftn, np.fft.irfftn, np.fft.fft2, np.fft.ifft2])
...
def test_irfft_with_n_large_regression():
    ...
    expected = np.array(
        [20.0, 9.91628173, -11.8819096, 7.1048486, -6.62459848, 4.0, -3.37540152, -0.16057669, 1.8819096, -20.86055364]
    )
