...
class TestFunctionEmitterVisitor(unittest.TestCase):
    ...
    def test_set_element(self) -> None:
        ...
        self.assert_emit(SetElement(Undef(self.struct_type), "b", self.b), """cpy_r_r0.b = cpy_r_b;""")
...
""",
    ...
    def assert_emit(
        ...
        *,
        ...
        assert_string_arrays_equal(expected_lines, actual_lines, msg="Generated code unexpected", traceback=True)
        if skip_next:
