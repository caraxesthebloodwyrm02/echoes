...
from scipy.stats._sensitivity_analysis import BootstrapSobolResult, f_ishigami, sample_AB, sample_A_B
...
class TestSobolIndices:
    ...
    @pytest.mark.parametrize(
        "func", [f_ishigami, pytest.param(f_ishigami_vec, marks=pytest.mark.slow)], ids=["scalar", "vector"]
    )
    ...
    def test_method(self, ishigami_ref_indices):
        ...
        _ = sobol_indices(func=f_ishigami, n=8, dists=self.dists, method=jansen_sobol_typed, rng=rng)
