    ...
    **Offset notation and scientific notation**
    ...
    def _format_maybe_minus_and_locale(self, fmt, arg):
        ...
        return self.fix_minus(
            ...
            (
                ",".join(locale.format_string(part, (arg,), True).replace(",", "{,}") for part in fmt.split(","))
    ...
    def _set_subs(self, subs):
        ...
        if subs is None:  # consistency with previous bad API
            ...
            try:
                ...
                raise ValueError("subs must be None, 'all', 'auto' or " "a sequence of floats, not " f"{subs}.") from e
            if self._subs.ndim != 1:
                raise ValueError(
                    "A sequence passed to subs must be " "1-dimensional, not " f"{self._subs.ndim}-dimensional."
                )
