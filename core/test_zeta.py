...
@pytest.mark.parametrize(
    ...
    [
        ...
        #
        # A small point in each quadrant outside of the critical strip
        ((3.12838509346655 + 7.111085974836645j), (1.0192654793474945 + 0.08795174413289127j), 1e-13),
        ((7.06791362314716 - 7.219497492626728j), (1.0020740683598117 - 0.006752725913243711j), 1e-13),
        ((-6.806227077655519 + 2.724411451005281j), (0.06312488213559667 - 0.061641496333765956j), 1e-13),
        ((-3.0170751511621026 - 6.3686522550665945j), (-0.10330747857150148 - 1.214541994832571j), 1e-13),
        # Moderately large imaginary part in each quadrant outside of critical strip
        ((6.133994402212294 + 60.03091448000761j), (0.9885701843417336 + 0.009636925981078128j), 1e-13),
        ((6.17268142822657 - 64.74883149743795j), (1.0080474225840865 + 0.012032804974965354j), 1e-13),
        ((-3.462191939791879 + 76.16258975567534j), (18672.072070850158 + 2908.5104826247184j), 1e-13),
        ((-6.955735216531752 - 74.75791554155748j), (-77672258.72276545 + 71625206.0401107j), 1e-13),
        # Points in critical strip
        ((0.4088038289823922 + 1.4596830498094384j), (0.3032837969400845 - 0.47272237994110344j), 1e-13),
        ((0.9673493951209633 + 4.918968547259143j), (0.7488756907431944 + 0.17281553371482428j), 1e-13),
        ((0.8692482679977754 + 66.6142398421354j), (0.5831942469552066 - 0.26848904799062334j), 1e-13),
        ((0.42771847720003764 + 21.783747851715468j), (0.4767032638444329 + 0.6898148744603123j), 1e-13),
        ((0.20479494678428956 + 33.17656449538932j), (-0.6983038977487848 + 0.18060923618150224j), 1e-13),
        ((0.4088038289823922 - 1.4596830498094384j), (0.3032837969400845 + 0.47272237994110344j), 1e-13),
        ((0.9673493951209633 - 4.918968547259143j), (0.7488756907431944 - 0.17281553371482428j), 1e-13),
        ((0.8692482679977754 - 66.6142398421354j), (0.5831942469552066 + 0.26848904799062334j), 1e-13),
        ((0.42771847720003764 - 21.783747851715468j), (0.4767032638444329 - 0.6898148744603123j), 1e-13),
        ...
        # Moderately large real part
        ((49.33915930750887 + 53.213478698903955j), (1.0000000000000009 + 1.0212452494616078e-15j), 1e-13),
        ((50.55805244181687 + 53.213478698903955j), (1.0000000000000004 + 4.387394180390787e-16j), 1e-13),
        ((49.33915930750887 + 40.6366015728302j), (0.9999999999999986 - 1.502268709924849e-16j), 1e-13),
        ((50.55805244181687 + 40.6366015728302j), (0.9999999999999994 - 6.453929613571651e-17j), 1e-13),
        ((49.33915930750887 + 85.83555435273925j), (0.9999999999999987 - 2.7014400611995846e-16j), 1e-13),
        ((50.55805244181687 + 85.83555435273925j), (0.9999999999999994 - 1.160571605555322e-16j), 1e-13),
        # Very large imaginary part
