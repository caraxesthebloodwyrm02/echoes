...
class TestPrintOptions:
    ...
    test_cases_gh_28679 = [
        ...
        (np.complex64([999999 + 999999j, 999999 + -1000000j]), "[999999.+9.99999e+05j 999999.-1.00000e+06j]"),
    ]
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (np.void((True, 2), dtype="?,<i8"), "(True, 2)", "np.void((True, 2), dtype=[('f0', '?'), ('f1', '<i8')])"),
        (np.void((1, 2), dtype="<f8,>f4"), "(1., 2.)", "np.void((1.0, 2.0), dtype=[('f0', '<f8'), ('f1', '>f4')])"),
