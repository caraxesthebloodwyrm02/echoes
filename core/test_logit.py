...
class TestLogit:
    ...
    def test_float32(self):
        a = np.concatenate(
            (np.linspace(0, 1, 10, dtype=np.float32), [np.float32(0.0001), np.float32(0.49999), np.float32(0.50001)])
        )
    ...
    def test_float64(self):
        a = np.concatenate((np.linspace(0, 1, 10, dtype=np.float64), [1e-8, 0.4999999999999, 0.50000000001]))
