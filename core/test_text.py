...
def test_antialiasing():
    ...
    fig.text(0.3, 0.25, r"$\sqrt{x}$", horizontalalignment="center", verticalalignment="center", antialiased=True)
    ...
    fig.text(0.7, 0.25, r"$\sqrt{x}$", horizontalalignment="center", verticalalignment="center", antialiased=False)
...
@pytest.mark.parametrize(
    "x, rotation, halign", [(0.7, 0, "left"), (0.5, 95, "left"), (0.3, 0, "right"), (0.3, 185, "left")]
)
...
def test_annotate_offset_fontsize():
    ...
    xy_text = [(10, 10), (1, 1)]
    anns = [
        ax.annotate("test", xy=(0.5, 0.5), xytext=xy_text[i], fontsize="10", xycoords="data", textcoords=text_coords[i])
        for i in range(2)
    ]
...
def test_text_annotation_get_window_extent():
    ...
    _, _, d = renderer.get_text_width_height_descent("text", annotation._fontproperties, ismath=False)
    _, _, lp_d = renderer.get_text_width_height_descent("lp", annotation._fontproperties, ismath=False)
