...
from core_trajectory import TrajectoryEngine, TrajectoryDirection
...
from realtime_preview import GlimpseOrchestrator, GlimpseConfiguration, create_glimpse
...
class TestVisualRenderer(unittest.TestCase):
    ...
    def test_render_timeline(self):
        ...
        trajectory_data = {
            ...
            "recent_points": [
                {"content": "test1", "direction": "expanding", "confidence": 0.8, 
                 "cause_effect_chain": [], "timestamp": time.time()},
                {"content": "test2", "direction": "expanding", "confidence": 0.9,
                 "cause_effect_chain": [], "timestamp": time.time()}
            ]
        }
    ...
    def test_ascii_preview(self):
        ...
        trajectory_data = {
            "current_direction": "expanding",
            "recent_points": [
                {"content": "test", "direction": "expanding", "confidence": 0.8,
                 "cause_effect_chain": [], "timestamp": time.time()}
            ]
        }
    ...
    def test_ansi_preview(self):
        ...
        trajectory_data = {
            "current_direction": "expanding",
            "recent_points": [
                {"content": "test", "direction": "expanding", "confidence": 0.9,
                 "cause_effect_chain": [], "timestamp": time.time()}
            ]
        }
        frame = self.renderer.render_timeline(trajectory_data)
    ...
    def test_image_preview_optional(self):
        ...
        trajectory_data = {
            "current_direction": "expanding",
            "recent_points": [
                {"content": "img", "direction": "expanding", "confidence": 0.8,
                 "cause_effect_chain": [], "timestamp": time.time()}
            ]
        }
        frame = self.renderer.render_timeline(trajectory_data)
    ...
    def test_export_animation(self):
        ...
        for i in range(3):
            data = {
                "current_direction": "stable",
                "recent_points": [
                    {"content": f"test{i}", "direction": "stable", "confidence": 0.5,
                     "cause_effect_chain": [], "timestamp": time.time()}
                ]
            }
...
class TestGlimpseOrchestrator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.system = GlimpseOrchestrator(
            config=config,
            base_path=Path(__file__).parent
        )
