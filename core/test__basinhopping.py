...
class TestBasinHopping:
    ...
    def test_all_nograd_minimizers(self):
        ...
        i = 1
        methods = ["CG", "BFGS", "L-BFGS-B", "TNC", "SLSQP", "Nelder-Mead", "Powell", "COBYLA", "COBYQA"]
        ...
        for method in methods:
            ...
            minimizer_kwargs["method"] = method
            res = basinhopping(
                func2d_nograd, self.x0[i], minimizer_kwargs=minimizer_kwargs, niter=niter, disp=self.disp, seed=1234
            )
            tol = self.tol
            if method == "COBYLA":
                tol = 2
    ...
    def test_rng_reproducibility(self):
        ...
        basinhopping(func2d, [1.0, 1.0], minimizer_kwargs=minimizer_kwargs, niter=10, callback=callback, rng=10)
        ...
        basinhopping(func2d, [1.0, 1.0], minimizer_kwargs=minimizer_kwargs, niter=10, callback=callback2, rng=10)
    ...
    def test_random_gen(self):
        ...
        res1 = basinhopping(func2d, [1.0, 1.0], minimizer_kwargs=minimizer_kwargs, niter=10, rng=rng)

        rng = np.random.default_rng(1)
        res2 = basinhopping(func2d, [1.0, 1.0], minimizer_kwargs=minimizer_kwargs, niter=10, rng=rng)
...
class Test_Metropolis:
    ...
    def test_gh7799(self):
        ...
        res = basinhopping(func, x0, 30, seed=np.random.RandomState(1234), minimizer_kwargs={"constraints": con})
        assert res.success
