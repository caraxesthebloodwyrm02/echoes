...
@image_comparison(
    ["arrow_styles.png"], style="mpl20", remove_text=True, tol=0 if platform.machine() == "x86_64" else 0.02
)
...
@image_comparison(
    ["connection_styles.png"], style="mpl20", remove_text=True, tol=0 if platform.machine() == "x86_64" else 0.013
)
