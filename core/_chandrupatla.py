...
def _chandrupatla(func, a, b, *, args=(), xatol=None, xrtol=None, fatol=None, frtol=0, maxiter=None, callback=None):
    ...
    maxiter = math.log2(finfo.max) - math.log2(finfo.smallest_normal) if maxiter is None else maxiter
    work = _RichResult(
        x1=x1,
        f1=f1,
        x2=x2,
...
def _chandrupatla_minimize(
    func, x1, x2, x3, *, args=(), xatol=None, xrtol=None, fatol=None, frtol=None, maxiter=100, callback=None
):
