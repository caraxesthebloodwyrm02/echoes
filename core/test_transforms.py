...
class TestAffine2D:
    ...
    def test_rotate_plus_other(self):
        ...
        trans = Affine2D().rotate_deg(90).skew_deg(26.5650512, 14.0362435)  # ~atan(0.5), ~atan(0.25)
    ...
    def test_translate_plus_other(self):
        ...
        trans = Affine2D().translate(23, 42).skew_deg(26.5650512, 14.0362435)  # ~atan(0.5), ~atan(0.25)
...
def test_offset_copy_errors():
    with pytest.raises(
        ValueError,
        match="'fontsize' is not a valid value for units;" " supported values are 'dots', 'points', 'inches'",
    ):
