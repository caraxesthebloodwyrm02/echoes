...
class ASTStubGenerator(BaseStubGenerator, mypy.traverser.TraverserVisitor):
    ...
    def visit_assignment_stmt(self, o: AssignmentStmt) -> None:
        ...
        for lvalue in o.lvalues:
            ...
            if (
                ...
                is_explicit_type_alias = o.unanalyzed_type and getattr(o.type, "name", None) == "TypeAlias"
    ...
    def is_alias_expression(self, expr: Expression, top_level: bool = True) -> bool:
        ...
        if isinstance(expr, CallExpr) and self.get_fullname(expr.callee) in TYPE_VAR_LIKE_NAMES:
            ...
            return self.is_alias_expression(expr.left, top_level=False) and self.is_alias_expression(
                expr.right, top_level=False
            )
        else:
            return False

    def process_typealias(self, lvalue: NameExpr, rvalue: Expression, is_explicit_type_alias: bool = False) -> None:
        p = AliasPrinter(self)
        if is_explicit_type_alias:
