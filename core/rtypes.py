...
cstring_rprimitive: Final = RPrimitive("cstring", is_unboxed=True, is_refcounted=False, ctype="const char *")
...
list_rprimitive: Final = RPrimitive("builtins.list", is_unboxed=False, is_refcounted=True, may_be_immortal=False)
...
KNOWN_NATIVE_TYPES: Final = {
    name: RPrimitive(name, is_unboxed=False, is_refcounted=True) for name in ["native_internal.Buffer"]
}
