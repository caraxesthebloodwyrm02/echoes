...
def setup(app: Sphinx) -> ExtensionMetadata:
    ...
    app.add_config_value("mathjax_inline", [r"\(", r"\)"], "html", types=frozenset({list, tuple}))
    app.add_config_value("mathjax_display", [r"\[", r"\]"], "html", types=frozenset({list, tuple}))
    app.add_config_value("mathjax_config", None, "html", types=frozenset({dict, NoneType}))
    ...
    app.add_config_value("mathjax3_config", None, "html", types=frozenset({dict, NoneType}))
