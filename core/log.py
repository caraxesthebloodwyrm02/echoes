...
def class_logger(cls: Type[_IT]) -> Type[_IT]:
    ...
    cls._should_log_debug = lambda self: logger.isEnabledFor(logging.DEBUG)  # type: ignore[method-assign]  # noqa: E501
    cls._should_log_info = lambda self: logger.isEnabledFor(logging.INFO)  # type: ignore[method-assign]  # noqa: E501
    cls.logger = logger
