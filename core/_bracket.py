...
def _bracket_root_iv(func, xl0, xr0, xmin, xmax, factor, args, maxiter):
    ...
    xl0, xr0, xmin, xmax, factor = xp_promote(xl0, xr0, xmin, xmax, factor, broadcast=True, force_floating=True, xp=xp)
...
def _bracket_minimum(func, xm0, *, xl0=None, xr0=None, xmin=None, xmax=None, factor=None, args=(), maxiter=1000):
    ...
    def check_termination(work):
        ...
        i = ((work.fl >= work.fm) & (work.fr > work.fm) | (work.fl > work.fm) & (work.fr >= work.fm)) & ~stop
        work.status[i] = eim._ECONVERGED
        stop[i] = True
