...
def setup(app: Sphinx) -> ExtensionMetadata:
    ...
    if sys.platform == "win32":
        ...
        app.add_config_value("image_converter_args", ["convert"], "env", types=frozenset({list, tuple}))
    else:
        ...
        # for these platforms.
        app.add_config_value("image_converter", "convert", "env", types=frozenset({str}))
        app.add_config_value("image_converter_args", [], "env", types=frozenset({list, tuple}))
