...
class ModelRouter:
    ...
    def __init__(self):
        ...
        self.web_search_indicators = [
            ...
            "news about", "current status", "happening now", "today",
            "now", "real-time", "live", "breaking", "just released"
        ]
        self.complexity_indicators = [
            ...
            "synthesize", "integrate", "comprehensive", "thorough",
            "detailed analysis", "deep dive", "investigate"
        ]
        self.math_indicators = [
            "solve", "equation", "integral", "derivative", "calculus",
            "algebra", "matrix", "theorem", "proof", "probability",
            "statistics", "variance", "regression", "polynomial",
            "limit", "series", "sigma", "pi", "gradient", "vector"
        ]
        self.science_indicators = [
            "physics", "chemistry", "biology", "experiment", "molecule",
            "quantum", "thermodynamics", "neuroscience", "astrophysics",
            "hypothesis", "simulation", "laboratory", "molecular",
            "genetics", "organic", "reaction", "particle", "spectroscopy"
        ]
    ...
    def _select_specialized_model(self, prompt: str) -> Optional[str]:
        ...
        code_block = "```" in prompt or re.search(r"\b(def|class|import|public|private|interface|lambda)\b", prompt_lower)
        ...
        scientific_pattern = re.search(r"\bmodel(?:ing)?\b|\bsimulate\b|\bhypothesis\b|\bexperiment\b", prompt_lower)
...
class ModelMetrics:
    ...
    def record_usage_sync(self, model: str, response_time: float, success: bool = True, cached: bool = False):
        """
    ...
    async def record_usage(self, model: str, response_time: float, success: bool = True, cached: bool = False):
        """
