...
class MediaService:
            ...
            "role_model_playlist": [
                {
                    "name": "The Climb",
                    "artist": "Miley Cyrus",
                    "message": "Life is about the journey",
                },
    ...
    def fetch_youtube_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "engagement": {"likes": 12500, "comments": 2500, "shares": 850},
        }
    ...
    def get_media_dashboard(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "notifications": [
                {
                    "platform": "YouTube",
                    "message": "New subscriber milestone: 12.5K",
                    "timestamp": datetime.now().isoformat(),
                },
                {
                    "platform": "Instagram",
                    "message": "Brand collaboration opportunity",
                    "timestamp": datetime.now().isoformat(),
                },
            ],
            "timestamp": datetime.now().isoformat(),
