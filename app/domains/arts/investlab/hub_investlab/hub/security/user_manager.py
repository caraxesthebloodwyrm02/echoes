...
class UserManager:
    ...
    def create_user_profile(self, user_data: Dict[str, Any], provider: str, tokens: Dict[str, Any]) -> str:
        ...
        profile = {
            ...
            'preferences': {
                ...
                'google': {
                    'subscriptions': ['gcp', 'workspace', 'android'],
                    'notifications': True
                },
                'twitter': {
    ...
    def update_user_preferences(self, provider: str, user_id: str, preferences: Dict[str, Any]) -> bool:
    ...
    def refresh_user_token(self, provider: str, user_id: str, new_tokens: Dict[str, Any]) -> bool:
        ...
        profile['tokens'].update({
            ...
            'refresh_token': new_tokens.get('refresh_token', profile['tokens'].get('refresh_token')),
