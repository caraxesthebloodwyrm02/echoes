...
class OAuthManager:
    ...
    def exchange_code_for_token(
        ...
        headers = {"Content-Type": "application/x-www-form-urlencoded", "User-Agent": "DataHub/1.0"}
    ...
    def get_user_info(self, provider: str, access_token: str) -> dict:
        ...
        headers = {"Authorization": f"Bearer {access_token}", "User-Agent": "DataHub/1.0"}
    ...
    def is_configured(self, provider: str) -> bool:
        ...
        config = self.providers[provider]
        return (
            config["client_id"] != f"your_{provider}_client_id"
            and config["client_secret"] != f"your_{provider}_client_secret"
        )
