...
def main():
    parser = argparse.ArgumentParser(description="QueensGambit: Daily Codebase Insights & Failsafe Logger")
    parser.add_argument('--report-dir', default='automation/reports', help='Directory to scan for reports')
    parser.add_argument('--output', default='queensgambit_insights.json', help='Output JSON file for insights')
