...
try:
    from core_modules.parallel_simulation_engine import (
        parallel_simulation, SimulationType, SimulationStatus
    )
...
def demo_concurrent_simulation():
    ...
    simulation_configs = [
        ...
        {
            "type": SimulationType.ALTERNATIVE_PATHS,
            "input_data": {"problem": "Decreasing sales revenue", "current_approach": ""},
    ...
    sim_id = parallel_simulation.create_simulation(
        ...
        input_data={
            ...
            "existing_references": [
                ...
                {"type": "technical", "description": "Implementation of neural networks"}
            ]
        },
        parameters={"priority": 0.7, "timeout": 20}
    )
...
def demo_decision_support():
    ...
    criteria = {"performance": 0.3, "ecosystem": 0.3, "learning_curve": 0.2, "job_market": 0.2}
...
def demo_real_time_simulation():
    ...
    sim_configs = [
        ...
        {
            "type": SimulationType.ALTERNATIVE_PATHS,
            "input_data": {"problem": "Complex optimization challenge", "current_approach": ""},
        ...
        for sim_id in simulation_ids:
            ...
            if status and status.status == SimulationStatus.COMPLETED:
                if sim_id not in [s for s in simulation_ids[:completed_count]]:
                    ...
                    if result:
                        print(f"  ✅ Completed: {result.simulation_type.value} "
