...
def create_telephone_communication() -> PodcastData:
    ...
    conversation_lines = [
        ...
        ("Caller", "He estado bien. Algunos días están bien, otros son difíciles y algunos son absolutamente fantásticos. Espero que estés bien.", "rhetorical"),  # Spanish response
        ("Recipient", "¡Qué maravilla escucharte! Me alegra que las cosas vayan bien en general.", "rhetorical"),  # Natural Spanish response
        ("Caller", "Ah, my dear friend! It's been ages since we spoke from these iconic booths.", "rhetorical"),
        ("Caller", "Remember when we'd queue for hours just to make a call home?", "rhetorical"),
        ("Recipient", "Indeed! These red sentinels have witnessed countless stories - proposals, emergencies, farewells.", "rhetorical"),
        ("Recipient", "Each coin dropped, each dial turned, each voice carried across the wires...", "cognitive_load"),
        ("Caller", "They may be fewer now, but their spirit lives on in London.", "rhetorical"),
        ...
        ("Operator", "Call completed. Please hang up and retrieve your change.", "other")
    ]
