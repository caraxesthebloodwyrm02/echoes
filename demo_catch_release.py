...
def demo_cross_reference():
    ...
    ai_content = [
        ("Artificial intelligence transforms industries through automation", ContentType.CONCEPT, {"ai", "automation"}),
        ("Machine learning algorithms learn patterns from data", ContentType.CONCEPT, {"ml", "algorithms"}),
        ("Neural networks mimic the human brain's structure", ContentType.CONCEPT, {"neural", "brain"}),
        ("Deep learning uses multiple layers of neural networks", ContentType.CONCEPT, {"deep", "learning"}),
        ("OpenAI develops advanced AI models like GPT-4", ContentType.ENTITY, {"openai", "gpt"}),
        ("Python is popular for AI development due to its libraries", ContentType.CONVERSATION, {"python", "ai"})
    ]
...
def demo_conversation_continuity():
    ...
    conversation = [
        ...
        ("Start with HTML, CSS, and JavaScript fundamentals", "assistant", {"html", "css", "javascript"}),
        ("What framework should I learn after JavaScript?", "user", {"javascript", "framework", "question"}),
        ("React is popular for building user interfaces", "assistant", {"react", "ui", "framework"}),
        ("How about backend development?", "user", {"backend", "development", "question"}),
        ("Node.js lets you use JavaScript for backend", "assistant", {"nodejs", "backend", "javascript"})
    ]
...
def demo_performance_optimization():
    ...
    bulk_content = [
        f"Test message {i} for performance testing"
        for i in range(100)
    ]
